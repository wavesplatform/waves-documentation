...
| 11 | [Скрипт ассета](/ride/script/script-types/asset-script.md) | script | Array[[Byte](/blockchain/blockchain/blockchain-data-types.md)] | S | S = 0 если значение поля 9 равно 0.1 <= S <= ≤ 8192 если значение поля 9 равно 1 |
